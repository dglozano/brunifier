...
int p;
float c;
};//CIERRA LA DEFINICIÓN DE struct Alumno EN LINEA 3
struct pepe {
	float c;
};//CIERRA LA DEFINICIÓN DE struct pepe EN LINEA 8
...
default: {
break;
}//CIERRA EL BLOQUE DE default EN LINEA 40 DE switch(t+1) EN LINEA 38
}//CIERRA EL BLOQUE DE switch(t+1) EN LINEA 38
}//CIERRA EL BLOQUE DE if(t==0) EN LINEA 36
break;
}//CIERRA EL BLOQUE DE case 0 EN LINEA 35 DE switch(t) EN LINEA 34
case 1: {
break;
}//CIERRA EL BLOQUE DE case 1 EN LINEA 47 DE switch(t) EN LINEA 34
...
cout<<i;
cout<<i;
}//CIERRA EL BLOQUE DE for(int j=0;j<10;j++) EN LINEA 57
}//CIERRA EL BLOQUE DE for(int i=0;i<10;i++) EN LINEA 56
return 0;
...
for(int j=0;j<10;j++) {
cout<<j;
}//CIERRA EL BLOQUE DE for(int j=0;j<10;j++) EN LINEA 67
return r;
}//CIERRA EL BLOQUE DE int suma(int x,int y) EN LINEA 64
